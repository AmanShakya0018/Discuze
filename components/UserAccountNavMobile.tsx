  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="bg-white dark:bg-black" align="end" side="right">
        ...
        <DropdownMenuItem asChild>
          <Link href="/termsofservice" className="text-zinc-700 dark:text-zinc-300">Terms of Service</Link>
        </DropdownMenuItem><DropdownMenuItem asChild>
          <Link href="/privacypolicy" className="text-zinc-700 dark:text-zinc-300">Privacy Policy</Link>
        </DropdownMenuItem>
